...
class ScrollIndexWidget extends StatelessWidget {
  ...
  const ScrollIndexWidget({Key? key, required this.child, required this.callback}) : super(key: key);
...
class ScrollToPositionWidget extends StatelessWidget {
  final ScrollView child;
  final ViewPortCallback callback;

  const ScrollToPositionWidget({Key? key, required this.child, required this.callback}) : super(key: key);
